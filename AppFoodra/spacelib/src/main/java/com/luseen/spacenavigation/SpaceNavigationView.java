...
public class SpaceNavigationView extends RelativeLayout {
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            centreButtonColor = typedArray.getColor(com.luseen.spacenavigation.R.styleable.SpaceNavigationView_centre_button_color, resources.getColor(com.luseen.spacenavigation.R.color.space_white));
            ...
            centreButtonIcon = typedArray.getResourceId(R.styleable.SpaceNavigationView_centre_button_icon, R.drawable.imgmenu);
            ...
            activeCentreButtonBackgroundColor = typedArray.getColor(R.styleable.SpaceNavigationView_active_centre_button_background_color, resources.getColor(com.luseen.spacenavigation.R.color.space_white));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (centreButtonColor == NOT_DEFINED)
            centreButtonColor = ContextCompat.getColor(context, R.color.space_white);
    ...
    private void addSpaceItems(LinearLayout leftContent, LinearLayout rightContent) {
        ...
        for (int i = 0; i < spaceItems.size(); i++) {
             ...
             */
            Typeface font2 = Typeface.createFromAsset(getContext().getAssets(), "GT-Walsheim-Regular.ttf");
                spaceItemText.setTypeface(font2);
